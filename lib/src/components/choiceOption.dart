...
class ChoiceOption extends StatelessWidget {
  ...
  Food food;
  List<Option> options;
  ChoiceOption({@required this.option,@required this.food,this.options});
...
imageErrorBuilder: (_, __, ___) => Container(
                        ...
                        Container(
                          ...
                          child: !_cartContext.withPrice || itemsOption.price.amount == null ? Text("") : Text("${itemsOption.price.amount == 0 ? '': itemsOption.price.amount/100}${itemsOption.price.amount == 0 ? '': "€"}",
